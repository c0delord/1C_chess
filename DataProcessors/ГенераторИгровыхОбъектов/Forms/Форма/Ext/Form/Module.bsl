...
&НаСервере
Процедура СоздатьФигуру(_Тип, _Цвет, _Ценность, _Символ, _Вертикаль, _Горизонталь, _МассивКлеток)
...
Процедура СоздатьФигурыНаСервере()
	...
	// +ДОБАВИЛ МЕХАНИЗМ <ПолучитьСимволФигуры> UPD
	//СоздатьФигуру(_Тип, _Цвет, _Ценность, _Символ, _Вертикаль, _Горизонталь, _МассивКлеток)
